...
<div class="container mx-auto px-4">
    <div class="max-w-6xl mx-auto">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Add New Popular Products</h1>
            <p class="mt-2 text-gray-600">Select products to feature in your popular products list.</p>
        </div>

        <!-- Product Selection Grid -->
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            <div class="p-6">
                <form action="{{ route('admin.popular-products.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mt-8 flex justify-end">
                        <button type="submit"
                            ...
                            Add to Popular Products (<span id="selected-count">0</span> selected)
                        </button>
                    </div>
                </form>
            </div>
