    ...
    <div class="flex items-center justify-between p-3 bg-white border border-gray-200 hover:bg-green-200 rounded-lg transition-colors duration-200">
        ...
        <div class="flex items-center space-x-3">
            <a href="{{ route('admin.categories.edit', $category->id) }}"
               class="flex items-center space-x-1 p-2 text-blue-500 hover:bg-white rounded-lg transition-colors duration-200">
            ...
            <form action="{{ route('admin.categories.destroy', $category->id) }}"
                ...
                @method('DELETE')
                <button type="submit"
                        class="flex items-center space-x-1 p-2 text-red-500 hover:bg-red-100 rounded-lg transition-colors duration-200">
